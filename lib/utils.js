...
export const setUnitKitPath = (path) =>
    atom.config.set('build-unitvm.unitvmKitHomeDir', path);
...
export const generateEUI64 = () => {
    ...
    return eui64[0].toString(16).toUpperCase() + ":" + 
                   eui64[1].toString(16).toUpperCase() + ":" + 
                   eui64[2].toString(16).toUpperCase() + ":" + 
                   eui64[3].toString(16).toUpperCase() + ":" + 
                   eui64[4].toString(16).toUpperCase() + ":" + 
                   eui64[5].toString(16).toUpperCase() + ":" + 
                   eui64[6].toString(16).toUpperCase() + ":" + 
                   eui64[7].toString(16).toUpperCase();
}