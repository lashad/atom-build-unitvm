...
export function activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      // 'build-unitvm:burnVM': () => this.burnVM(),
...
export function selectSerialPort() {
  ...
  this.serialListView.awaitSelection().then(newPort => {
    ...
    atom.notifications.addSuccess(`Serial port '${newPort}' was selected`);
...
// export function burnVM() {
//
//   this.vmListView = new ListView();
//
//   this.vmListView.awaitSelection().then(newPort => {
//
//
//     this.vmListView = null;
//
//   }).catch((err) => {
//     this.vmListView.setError(err.message);
//     this.vmListView = null;
//   });
//
// }
