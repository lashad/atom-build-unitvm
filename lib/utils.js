...
const resourceSchemaFileName = '.resource.yml';
...
export const getResourceSchemaPath = () => {
    let filePath = path.join(getProjectDirectory(), resourceSchemaFileName);
    if(!fs.existsSync(filePath)) {
        return null;
    }
...
export const getConfigPath = () => {
    return path.join(getProjectDirectory(), defaultConfigFileName);
}
