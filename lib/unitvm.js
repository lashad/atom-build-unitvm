...
export function provideBuilder() {
    ...
    return class UnitVMBuildProvider extends EventEmitter {
        ...
        settings() {
            ...
            // avrdude -c arduino -p atmega328p -P /dev/cu.usbserial-A6007Whc -b57600 -e -U flash:w:unitvm
            ...
            return [defaultTarget, uvmcTarget, uploadDeviceTarget, cleanBuildTarget];
